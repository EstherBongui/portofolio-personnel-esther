    ...
    <footer className="footer-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-gray-100 hover:text-primary transition duration-300 transform hover:scale-110"
            ...
            <div className="text-gray-100 text-sm">
              <p>📧 estherbongui@gmail.com</p>
              <p>📍 Lévis, Québec, Canada</p>
              <p>🎓 UQAR - Baccalauréat en Informatique</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-500 pt-8 text-center">
          <p className="text-gray-100 text-sm">
            © {currentYear} Esther. Tous droits réservés.
          </p>
        </div>
        ...
        <div className="text-center mt-8">
          <a
            href="#home"
            className="inline-block p-3 bg-primary hover:bg-blue-600 rounded-full transition duration-300 transform hover:scale-110"
