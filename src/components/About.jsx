...
const Illustration = () => (
  <div className="w-64 h-64 md:w-80 md:h-80 relative flex items-center justify-center">
    <svg viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" aria-hidden="true">
      ...
      {/* Leaf 1 — bottom left */}
      <g className="leaf1">
        <path d="M160 200 C140 185 118 188 110 200 C118 210 140 208 160 200 Z"
          fill="#9FB2AC" opacity="0.75"/>
        <line x1="160" y1="200" x2="115" y2="200" stroke="rgba(93,13,24,0.2)" strokeWidth="0.8" strokeLinecap="round"/>
      </g>

      {/* Leaf 2 — mid right */}
      <g className="leaf2">
        <path d="M160 168 C180 152 202 154 210 165 C202 176 180 175 160 168 Z"
          fill="#9FB2AC" opacity="0.85"/>
        <line x1="160" y1="168" x2="205" y2="165" stroke="rgba(93,13,24,0.2)" strokeWidth="0.8" strokeLinecap="round"/>
      </g>

      {/* Leaf 3 — upper left */}
      <g className="leaf3">
        <path d="M160 142 C142 126 120 128 113 140 C121 150 142 148 160 142 Z"
          fill="#9FB2AC" opacity="0.65"/>
